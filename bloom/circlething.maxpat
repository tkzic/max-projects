...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 476.0, 196.0, 47.0 ],
					"text" : "If using Leap Motion sensor, you will need to open and run leap-finger-switch.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 86.0, 380.0, 150.0, 20.0 ],
					"text" : "1 is for mouse"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 407.0, 101.0, 33.0 ],
					"text" : "2 is for LeapMotion"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 40.0, 342.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 86.0, 407.0, 32.5, 18.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.0, 380.0, 32.5, 18.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 435.0, 72.0, 20.0 ],
					"text" : "s trig-select"
				}
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.644853, 1.0, 0.741469, 0.28 ],
					"fontname" : "Arial",
					"fontsize" : 14.0,
					"frgb" : 0.0,
					"id" : "obj-5",
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 293.0, 174.0, 38.0 ],
					"text" : "click mouse in the jit.window to play"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 165.0, 123.0, 93.0, 33.0 ],
					"text" : "everything is in here"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 165.0, 26.0, 93.0, 47.0 ],
					"text" : "not sure what this does but I threw it in"
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 483.5, 475.0, 150.0, 33.0 ],
									"text" : "pack:\ntime x y pan R G B"
								}
...
,
					"patching_rect" : [ 165.0, 86.0, 93.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 234.0, 218.0, 47.0 ],
					"text" : "tz - the circle drawing happens inside: SynthPiano subpatch - then its done via a Poly abstraction FMPoly~"
				}
...
,
					"patching_rect" : [ 70.0, 86.0, 78.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 40.0, 26.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 40.0, 161.0, 57.0, 20.0 ],
					"text" : "t b erase"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 40.0, 111.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 40.0, 136.0, 58.0, 20.0 ],
					"text" : "metro 50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 40.0, 204.0, 127.0, 20.0 ],
					"text" : "jit.gl.render circlething"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 70.0, 61.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 70.0, 111.0, 50.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 130.0, 155.0, 55.0, 20.0 ],
					"triangle" : 0
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 792.0, 179.0, 51.0, 20.0 ],
									"text" : "r leap-y"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 787.0, 96.5, 61.0, 20.0 ],
									"text" : "r leap-trig"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 605.0, 65.0, 70.0, 20.0 ],
									"text" : "r trig-select"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 495.0, 278.0, 32.5, 18.0 ],
									"text" : "3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 564.0, 489.0, 68.0, 20.0 ],
									"text" : "random 40"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 605.0, 566.0, 162.0, 47.0 ],
									"text" : "in the real bloom, each new circle lets the previous one exist and they overlap"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 502.0, 365.0, 32.5, 18.0 ],
									"text" : "2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 472.0, 329.0, 32.5, 18.0 ],
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 466.0, 457.0, 46.0, 20.0 ],
									"text" : "gate 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "int", "", "", "int" ],
									"patching_rect" : [ 425.0, 515.0, 77.0, 20.0 ],
									"text" : "counter 1 40"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "bang", "bang", "int" ],
									"patching_rect" : [ 425.0, 491.0, 46.0, 20.0 ],
									"text" : "uzi 40"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 302.0, 566.0, 156.0, 47.0 ],
									"text" : "banging here works but each new bang erases the blooming circle"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 572.0, 382.0, 150.0, 20.0 ],
									"text" : "this was original message"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 478.0, 566.0, 20.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 515.0, 551.0, 66.0, 20.0 ],
									"text" : "pack 0 0 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "bang", "bang", "bang" ],
									"patching_rect" : [ 456.0, 390.0, 46.0, 20.0 ],
									"text" : "t b b b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 509.25, 491.0, 32.5, 18.0 ],
									"text" : "40"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 543.0, 417.0, 205.0, 18.0 ],
									"text" : "target $1, 60 5 65 400 300 200. 0. 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 726.5, 481.0, 75.0, 20.0 ],
									"text" : "random 500"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 634.0, 489.0, 75.0, 20.0 ],
									"text" : "random 500"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 720.0, 266.0, 32.5, 18.0 ],
									"text" : "40"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 646.5, 255.0, 32.5, 18.0 ],
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 605.0, 34.0, 150.0, 20.0 ],
									"text" : "test bang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 555.0, 25.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 82.0, 506.0, 137.0, 18.0 ],
									"text" : "50 74 0.5 50 50 200 0 0"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 162.0, 438.0, 150.0, 47.0 ],
									"text" : "tz - the actual drawing happens inside the FMPoly~ sub patch"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 500.0, 179.0, 51.0, 51.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 555.0, 165.0, 60.0, 20.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 555.0, 305.0, 191.0, 18.0 ],
									"text" : "target $1, 60 5 65 $2 $3 200. 0. 0."
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 492.25, 130.0, 32.5, 18.0 ],
													"text" : "0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "int", "int" ],
													"patching_rect" : [ 508.5, 58.5, 50.0, 20.0 ],
													"text" : "change"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 511.25, 100.0, 46.0, 20.0 ],
													"text" : "t b i i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "" ],
													"patching_rect" : [ 538.25, 130.0, 36.0, 20.0 ],
													"text" : "sel 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 760.5, 149.0, 32.5, 20.0 ],
													"text" : "i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 669.5, 141.0, 32.5, 20.0 ],
													"text" : "i"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 475.0, 100.0, 20.0, 20.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 396.0, 56.0, 68.0, 47.0 ],
													"text" : "source: 1 = mouse 2 = external"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 366.5, 56.0, 25.0, 25.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 701.5, 69.0, 32.0, 20.0 ],
													"text" : "x"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 800.0, 69.0, 32.0, 20.0 ],
													"text" : "y"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 768.0, 69.0, 25.0, 25.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 669.5, 69.0, 25.0, 25.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 508.5, 29.0, 25.0, 25.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 421.0, 210.0, 54.0, 20.0 ],
													"text" : "switch 2"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 315.0, 87.5, 32.5, 18.0 ],
													"text" : "1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 300.0, 49.5, 60.0, 20.0 ],
													"text" : "loadbang"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 446.0, 160.0, 150.0, 20.0 ],
													"text" : "mouse click"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 411.0, 160.0, 20.0, 20.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int", "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 273.477173, 235.68396, 50.0, 19.0 ],
													"triscale" : 0.9
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int", "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 220.0, 235.0, 50.0, 19.0 ],
													"triscale" : 0.9
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 216.522827, 188.362671, 65.0, 19.0 ],
													"text" : "unpack i i i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "", "" ],
													"patching_rect" : [ 235.0, 160.0, 129.0, 19.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "" ],
													"patching_rect" : [ 50.0, 130.0, 193.0, 20.0 ],
													"text" : "jit.window circlething 0 50 800 650"
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 45.0, 383.0, 136.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 45.0, 408.0, 195.0, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 87.5, 296.0, 139.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "int", "", "", "int" ],
									"patching_rect" : [ 10.0, 350.0, 77.0, 20.0 ],
									"text" : "counter 1 40"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 235.0, 275.0, 187.0, 33.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 230.0, 90.0, 150.0, 33.0 ],
									"text" : "pack:\ntime x y pan R G B"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 42.5, 266.0, 139.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 45.0, 457.0, 114.0, 20.0 ],
									"text" : "poly~ FMPoly2~ 40"
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 219.5, 252.0, 172.0, 252.0 ],
									"source" : [ "obj-150", 5 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 199.5, 252.0, 154.857147, 252.0 ],
									"source" : [ "obj-150", 4 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 179.5, 252.0, 137.714279, 252.0 ],
									"source" : [ "obj-150", 3 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 159.5, 252.0, 86.285713, 252.0 ],
									"source" : [ "obj-150", 2 ]
								}
...
,
					"patching_rect" : [ 165.0, 161.0, 82.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "FMPoly2~.maxpat",
				"bootpath" : "/Users/tkzic/max-projects/bloom",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
